	...
	skillManifest(): DatasourceSkillManifest {
		...
		return {
			...
			content: [
				...
				"",
				"## How to search",
				`Call the dedicated \`${datasourceSearchToolName(skillName)}\` tool with a natural-language \`query\`. Optionally pass \`topK\` and a narrowing \`scope\`. Available authorized scopes:`,
