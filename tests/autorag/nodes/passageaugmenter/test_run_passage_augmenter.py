...
from tests.autorag.nodes.passageaugmenter.test_base_passage_augmenter import qa_data, corpus_data, previous_result
...
def test_run_passage_augmenter_node(node_line_dir):
    ...
    assert os.path.exists(os.path.join(node_line_dir, "passage_augmenter", f"best_{best_path}"))
