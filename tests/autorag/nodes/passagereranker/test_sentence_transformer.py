from autorag.nodes.passagereranker import sentence_transformer
...
def test_sentence_transformer():
    top_k = 3
    original_sentence_transformer = sentence_transformer.__wrapped__
...
def test_sentence_transformer_node():
    top_k = 1
    result_df = sentence_transformer(project_dir=project_dir, previous_result=previous_result, top_k=top_k)
