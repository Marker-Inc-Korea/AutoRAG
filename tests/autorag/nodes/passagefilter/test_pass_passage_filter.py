...
from tests.autorag.nodes.passagefilter.test_passage_filter_base import project_dir, previous_result, contents_example, \
    ids_example, scores_example


def test_pass_passage_filter():
    result_df = pass_passage_filter(project_dir=project_dir, previous_result=previous_result)
